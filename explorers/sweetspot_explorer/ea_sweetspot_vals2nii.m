function fnames = ea_sweetspot_vals2nii(space, vals, outdir, basename)
% Write a voxelwise stat map (as produced by ea_sweetspot_calcstats /
% permtest, one column vector per side) into nifti file(s), using the grid
% geometry in space{side} (e.g. obj.results.space, or the .space field
% saved in a <ID>_permtest.mat file).
%
