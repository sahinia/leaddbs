function dpvl = ea_sweetspot_palm_dpxlabel(dpx,adj)
...
% ea_sweetspot_palm_tfce.m (the volume branch uses MATLAB's bwconncomp
...
% ea_sweetspot_palm_tfce.m's header for the full citation note.
%
% Label a DPV file (vertexwise data).
%
% Usage:
% dpxl = ea_sweetspot_palm_dpxlabel(dpx,adj)
%
